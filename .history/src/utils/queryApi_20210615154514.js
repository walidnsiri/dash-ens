          ...
          for (let [key, value] of Object.entries(body)) {
            if (value) {
              ...
              if (Array.isArray(value)) {
                console.log("d5alt 3asba fi wost el array");
                let numberOfItems = 0
                value.forEach(v => {
                  if (typeof v !== "string" && v instanceof File === false) {
                    ...
                    console.log("zebi foug etawla")
                    bodyFormData.append(`${key}[${numberOfItems}]`, new Blob([JSON.stringify(v)],{type : "application/json"}));
                  } else {
                    console.log("zebi ta7t el etawla")

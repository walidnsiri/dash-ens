        ...
        <CCard className="border-0 shadow-sm">
          <CCardBody>
            <div className="card-botton p-5">
              <div className="message">
                ...
                <div className="small text-muted text-truncate">
                  consulter tous les notifiations reçus
                </div>
              </div>
            </div>
            <div className="card-botton p-5">
              <div className="message">
                ...
                <div className="small text-muted text-truncate">
                  consulter tous les notifiations RDI
                </div>
              </div>
            </div>
            <div className="card-botton p-5">
            <div className="message">
                ...
                <div className="small text-muted text-truncate">
                  consulter tous les notifiations d'encadrement
                </div>
              </div>
            </div>
            <div className="card-botton p-5">
            <div className="message">
                ...
                <div className="small text-muted text-truncate">
                  consulter tous les notifiations supprimées
                </div>
              </div>
            </div>
          </CCardBody>

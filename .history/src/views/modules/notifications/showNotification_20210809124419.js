      ...
      <CCol lg="12" xl="4" xxl="4">
        <CCard className="border-0 shadow-sm d-flex">
          <CCardBody className="p-0 align-items-center justify-content-center">
            ...
            <div className="notification-card-botton" onClick={() => handleClick(1)}>
            ...
            />
            <div className="notification-card-botton" onClick={()=>handleClick(2)}>
            ...
            />
            <div className="notification-card-botton" onClick={() =>handleClick(3)} style={{backgroundColor:clicked[3]?"#e74c3c":"white"}}>
              <div className="message">
                <div className="pt-3 mr-3 float-left">icon</div>
                <div className="text-truncate font-weight-bold" style={{color:clicked[3]?"primary":"white"}}>
                  Encadrement
                </div>
                <div className="small text-truncate mt-2" style={{color:clicked[3]?"primary":"#ffff"}}>
            ...
            />
            <div className="notification-card-botton" onClick={()=>handleClick(4)}>
              <div className="message">
                <div className="pt-3 mr-3 float-left">icon</div>

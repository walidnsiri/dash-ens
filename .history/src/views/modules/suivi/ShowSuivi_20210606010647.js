          ...
          <CCard className="border-0 shadow-sm pb-1">
            <CCardBody>
              ...
              <ul className="list-group flex-md-row flex-md-wrap">
                <li className="col-lg-2 col-md6 col-12 rounded-0 border-left-0 border-top border-bottom-0">
                  <CCard
                ...
                <li className="list-group-item col-lg-2 col-md6 col-12 rounded-0 border-left-0 border-top border-bottom-0">
                ...
                <li className="list-group-item col-lg-2 col-md6 col-12">
                  <CCard className="shadow-sm border-0 small-card-as-button">
                    <CCardBody>
                      <CCallout color="danger d-inline-block mt-0">

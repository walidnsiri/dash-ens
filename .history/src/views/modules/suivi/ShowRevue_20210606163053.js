...
const ShowRevue = () => {
  return (
    <div className="performance-wrapper">
      <h1 className="performance-title">Meilleur Performance de la semaine</h1>
      <div className="performance-top">
        <figure className="performance-thumbnail"></figure>
      ...
      <div className="performance-enseignant">
        <figure className="single-enseignant">E</figure>
        <figure className="single-enseignant">F</figure>
        <figure className="single-enseignant">G</figure>
        <figure className="single-enseignant">H</figure>
      </div>

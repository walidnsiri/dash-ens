      ...
      <CRow>
        <CCol xs="12" sm="12" md="12" lg="12" xl="12">
          <CCard className="border-0 shadow-sm pb-1">
            ...
            <ul className="list-group flex-md-row flex-md-wrap">
              <li className="li-suivi list-group-item col-lg-2 col-md-6 col-12 rounded-0 border-left-0 border-bottom border-bottom-0 ">
              ...
              <li className="li-suivi list-group-item col-lg-2 col-md-6 col-12 rounded-0 border-left-0 border-top border-bottom-0 justify-content-center">
                <CCallout color="danger d-inline-block mt-0">
                  <h6 className="mb-1">Congés</h6>
                  <strong className="h4 mb-0">7</strong>
                </CCallout>
              </li>
              <li className="li-suivi list-group-item col-lg-2 col-md-6 col-12 rounded-0 border-left-0 border-top border-bottom-0 ">
                <CCallout color="danger d-inline-block mt-0">

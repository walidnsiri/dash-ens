        ...
        <div className="performance-wrapper">
          ...
          <div className="performance-top">
            <figure className="performance-thumbnail">
              <div className="performance-card podium">
                ...
                <div className="podium-base">
                  ...
                  <div className="podium-info">
                    <div className="podium-name">da3boul</div>
                    <div className="podium-score"><small>160</small></div>
                  </div>
                  </div>
                </div>
                <div className="podium-item">
                <div className="podium-base">
                  ...
                  <div className="podium-info">
                    <div className="podium-name">Sabri ben marzouk</div>
                    <div className="podium-score">120</div>
                  </div>
                </div>
                </div>
              </div>

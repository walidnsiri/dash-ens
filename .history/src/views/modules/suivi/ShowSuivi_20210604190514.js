    ...
    <>
      ...
      <CRow className="mr-5 ml-5 heigher-row">
        <CCol xs="2" sm="2" md="2" lg="2" xl="2">
          <CCard className="mb-5 shadow-sm border-0 small-card-as-button" onClick={() => setchar("rdi")}>
            <CCardBody>
        ...
        <CCol xs="2" sm="2" md="2" lg="2" xl="2">
          <CCard className="mb-5 shadow-sm border-0 small-card-as-button" onClick={() => setchar("interventions")}>
            <CCardBody>
              <CCallout color="danger d-inline-block mt-0">

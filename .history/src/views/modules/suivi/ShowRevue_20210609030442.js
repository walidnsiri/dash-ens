...
import cup from "../../../assets/img/Gold-Trophy.png"
const ShowRevue = () => {
  return (
    <>
          ...
          <div className="performance-top">
            <figure className="performance-thumbnail">
              <div className="performance-card">
                <div className="image" style={ { backgroundImage: "url('https://s3.us-east-2.amazonaws.com/housessoldeasily.com/img/propertie/4.jpg')" } }></div>

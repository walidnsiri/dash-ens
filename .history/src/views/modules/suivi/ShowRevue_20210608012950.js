              ...
              <figure className="single-enseignant">
                ...
                <figcaption className="single-enseignant-info">
                  ...
                  <div className="info-scores">
                    <span className="info-single-score">Formations 50</span>
                    <span className="info-single-score">Services 12</span>
                    <span className="info-single-score">Interventions 6</span>
                  </div>
                  <div className="info-scores">
                    <span className="info-single-score2">RDI 18</span>
                    <span className="info-single-score2">Encadrements 21</span>
                    <span className="info-single-score2 info-single-score-total">
                      | 115
                    </span>
                  </div>
                </figcaption>

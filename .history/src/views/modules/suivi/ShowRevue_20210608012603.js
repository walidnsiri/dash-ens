              ...
              <figure className="single-enseignant">
                ...
                <figcaption className="single-enseignant-info">
                  ...
                  <div className="info-scores">
                    <span className='info-single-score'>RDI: 18</span>
                    <span className='info-single-score'>CONGES: 20</span>
                    <span className='info-single-score'>Encadrements: 21</span>
                    <span className='info-single-score'>Formations50</span>
                    <span className='info-single-score'>12</span>
                    <span className='info-single-score'>6</span>
                    <span className="info-single-score info-single-score-total">115</span>
                  </div>
                </figcaption>
              </figure>
              <figure className="single-enseignant">

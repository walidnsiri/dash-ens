...
const ShowUsers = () => {
 ...
 <CRow className="d-flex justify-content-center">
    ...
    {users.length === 0 && 
    <CCol sm="12" xl="12" xs="12" md="12" style={{paddingTop:"4%", paddingBottom: "42%"}}>
    <CAlert color="warning">Pas d'utilisateurs trouvés.</CAlert>
  </CCol>
    }
          ...
          <CRow>
         <CCol className="mr-4" style={{position: "absolute", "bottom": "20%"}}>
          <CPagination
            className="mt-4"
            align="end"

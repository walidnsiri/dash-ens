...
//import dropzoneAccept from "../../../components/custom/dropzoneAccept";
  ...
  function nodeChecked(args) {
    ...
    if (checkednodes.length > 0) {
      checkednodes.forEach((elem) => {
        ...
        if (role !== undefined) rols.push(role);
      });
    }
    setRoles(rols);
  }
                  ...
                  <CCol sm="6">
                    <CFormGroup>
                      ...
                      {formik.errors.username && formik.touched.username ? (
                        ...
                        <CFormText>Nom complet de l'utilisateur à ajouter</CFormText>
                      )}
                    </CFormGroup>
                    <CFormGroup>
              ...
              <CRow>
                <CCol className="float-left">
                  <h5 className="mt-4 ml-4">
                    ...
                    <br />
                    <small>
                      Veuillez entrer le(s) rôle(s) de(s) (l')utilisateur(s)
                    </small>
                  </h5>
                </CCol>
                <CCol className="float-right mt-4 mr-4">
                  <div className="card-header-actions">
                    ...
                    >
                      <CIcon
                        name={collapsed1 ? "cil-arrow-top" : "cil-arrow-bottom"}
                      />
                    </CButton>
                  </div>
                </CCol>
              ...
              <CCollapse show={collapsed1} timeout={1000}>
                <CCardBody>
                  {rolevalidation && (
                    <CFormText>
                      <p className="text-danger">
                        Veuillez choisir le(s) role(s) de l'utilisateur
                      </p>
                    </CFormText>
                  )}
                  <TreeViewComponent
